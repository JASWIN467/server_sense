            ...
            <div className="relative z-10 w-full max-w-md px-4">
                ...
                >
                    ...
                    >
                        ...
                        <div className="relative my-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-transparent text-gray-500 bg-surface">Or continue with</span>
                            </div>
                        </div>
                    ...
                    <div className="mt-8 text-center text-gray-400 text-sm">
                        Don't have an account? <Link to="/register" className="text-primary font-semibold hover:text-primary/80 ml-1">Sign up</Link>
                    </div>
                </motion.div>
            </div>
        </div>
